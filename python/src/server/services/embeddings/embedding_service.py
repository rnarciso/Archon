...
from ..utils.progress_utils import create_embedding_rate_limit_callback
            ...
            async with get_llm_client(provider=provider, use_embedding_provider=True) as client:
                ...
                for i in range(0, len(texts), batch_size):
                    ...
                    try:
                        ...
                        # Create rate limit progress callback
                        rate_limit_callback = create_embedding_rate_limit_callback(
                            progress_callback,
                            websocket,
                            result,
                            texts
